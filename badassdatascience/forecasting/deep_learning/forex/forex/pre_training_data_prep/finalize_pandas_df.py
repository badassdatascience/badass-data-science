...
def finalize_pandas_candlesticks(**config):
    ...
    shifted_as_needed_file_name_and_path = config['directory_output'] + '/' + config['filename_shift_days_and_hours_as_needed']
    ...
    pandas_finalized_file_name_and_path = config['directory_output'] + '/' + config['filename_finalized_pandas']
